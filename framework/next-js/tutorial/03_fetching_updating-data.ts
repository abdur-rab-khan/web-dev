...
|                                                                                                                                                                                     |
|    🔷 If we want to revalidate the data after some time then we can use "fetch" with "next: {revalidate: 10}" option, it will revalidate the data after every 10 seconds. but if    |
|       we want to revalidate the whole page after some time then we can use "export const revalidate = 10;"                                                                          |
|                                                                                                                                                                                     |
|                                                                                                                                                                                     |
